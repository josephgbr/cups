...
Os arquivos de modelos são arquivos HTML com caracteres de formatação especial
...
modify-class.tmpl | Esse modelo é usado como a primeira forma ao modificar uma
classe.  
